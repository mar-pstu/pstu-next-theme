...
add_action( 'customize_register', function ( $wp_customize ) {
	...
	$wp_customize->add_section(
		...
		array(
			'title'       	=> __( 'Секция "Новости"', 'pstu-next-theme' ),
			'priority'    	=> 10,
			'description' 	=> __( 'Настройки секции новостей главной страницы' , 'pstu-next-theme' ),
	...
	$wp_customize->add_control(
		...
		array(
			'section'				=> 'pstu_next_theme_news',
			'label'					=> __( 'Текстовый "значок"', 'pstu-next-theme' ),
			'type'					=> 'text',
		)
	); /**/
