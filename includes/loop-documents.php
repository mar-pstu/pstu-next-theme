...
if ( have_posts() ) {
	...
	while ( have_posts() ) {
		...
		echo "      <img class=\"lazy media-object\" src=\"#\" data-src=\"images/document-thumbnail.png\" alt=\"" . $title_attribute . "\"/>\r\n";
		echo "    </a>\r\n";
		echo "  </div>\r\n"; // .media-left
		...
		if ( has_excerpt( get_the_ID() ) ) echo "    <div class=\"excerpt\">" . apply_filters( 'the_excerpt', get_the_permalink( get_the_ID() ) ) . "</div>\r\n";
		echo "      <div class=\"text-right\">\r\n";
		if( current_user_can( 'delete_posts', get_the_ID() ) ) echo "<a class=\"btn btn-danger\" href=\"". get_delete_post_link( $post->ID) ."\">" . __( 'Удалить', 'pstu-next-theme' ) . "</a>";
