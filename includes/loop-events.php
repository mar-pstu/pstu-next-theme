...
if ( have_posts() ) {
	...
	while ( have_posts() ) {
		...
		echo "    <h4 class=\"media-heading\"><a href=\"" . get_the_permalink( get_the_ID() ) . "\" title=\"" . $title_attribute . "\">" ." . apply_filters( 'the_title', ( ( preg_match( PSTU_NEXT_EVENTS_DATE_REG, $events_entry->post_title ) ) ? substr( trim( $events_entry->post_title ), 10 ) : $events_entry->post_title ) ) . " . "</a></h4>\r\n";
