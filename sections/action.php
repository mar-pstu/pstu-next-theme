...
$action_section_title = trim( wp_strip_all_tags( get_theme_mod( 'action_section_title', '' ) ) );
$action_section_subtitle =  trim( wp_strip_all_tags( get_theme_mod( 'action_section_subtitle', '' ) ) );
if ( ! empty( $action_section_title ) ) echo "<h2>" . ( ( function_exists( 'pll__' ) ) ? pll__( $action_section_title ) : $action_section_title ) . "</h2>\r\n";
if ( ! empty( $action_section_subtitle ) ) echo ( ( function_exists( 'pll__' ) ) ? pll__( $action_section_subtitle ) : $action_section_subtitle );
echo "        </div>\r\n";
echo "      </div>\r\n"; // .col-
